...
public class ExamView extends JFrame {
	...
	public ExamView(final Teacher teacher) {
		...
		buttonRemove = new JButton("Remove Exam");
		...
		buttonView = new JButton("Scan Student Sheet");
		...
		btnAddResult = new JButton("Add Student ");
		...
		btnViewExam = new JButton("View Exam Marks");
